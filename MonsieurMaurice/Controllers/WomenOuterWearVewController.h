...
@interface WomenOuterWearVewController : UIViewController <UIPickerViewDataSource, UIPickerViewDelegate, UIActionSheetDelegate, NSXMLParserDelegate>
...
//@property (weak, nonatomic) IBOutlet UIImageView *pickerSelectorView;
